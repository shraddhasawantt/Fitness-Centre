...
try:
    ...
    py3 = True
def click_newcust():
    call(["python", "newcust.py"])    #Make a Call to the other Class
def click_bmi():
    call(["python", "bmi.py"])                    #Make a Call to the other Class
def click_checkout():
    call(["python", "checkoutgui.py"])                #Make a Call to the other Class
def click_Query():
    call(["python", "Query.py"])
...
class FITNESS_HUB:
    def __init__(self):
        ...
        self.Button2.configure(text='''1.NEW CUSTOMER''')
        self.Button2.configure(width=566)
        self.Button2.configure(command=click_newcust)
        ...
        self.Button3.configure(text='''2.CALCULATE BMI''')
        self.Button3.configure(width=566)
        self.Button3.configure(command=click_bmi)
        ...
        self.Button5.configure(text='''4.QUERY''')
        self.Button5.configure(width=566)
        self.Button5.configure(command=click_Query)
